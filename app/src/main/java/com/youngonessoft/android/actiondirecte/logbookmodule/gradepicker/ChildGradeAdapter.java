package com.youngonessoft.android.actiondirecte.logbookmodule.gradepicker;
...
public class ChildGradeAdapter extends CursorAdapter {

    public ChildGradeAdapter(Context context, Cursor cursor) {
